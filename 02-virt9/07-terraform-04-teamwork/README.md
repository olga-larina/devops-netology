# Olga Ivanova, devops-10. Домашнее задание к занятию "7.4. Средства командной работы над инфраструктурой."
...
[atlantis.yaml](file/atlantis.yaml)   
[server.yaml](file/server.yaml)
